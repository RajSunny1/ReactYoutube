...
import logo from "../../public/youtubeicon1.png";
import profile from "../../public/youtubeprofileicon.png";
  ...
  return (
    <div className="flex justify-between fixed top-0 w-[100%] bg-white px-6 py-2">
      ...
      <div className=" flex w-[35%] items-center ">
        <div className="w-[100%] px-4 py-2 rounded-l-full border border-gray-400 1px ">
